 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |EECLR |      |      |      |      |      |           |      | WH-R | WH-U | WH_D | WH_L |      |  \     |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[MACFN] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS,      KC_NO,      MS_ACL0,    MS_ACL1, MS_ACL2, KC_NO,                               MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, KC_NO,   KC_TRNS,
    KC_TRNS,      EE_CLR,     KC_NO,      KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_NO,        MS_WHLL, MS_WHLU, MS_WHLD, MS_WHLR, KC_NO,   KC_TRNS,
